...
def attack(char_name: str, char_class: str) -> str:
    """The function describes the logic of
...
def defence(char_name: str, char_class: str) -> str:
    """The function assigns protection depending on the character."""
...
def special(char_name: str, char_class: str) -> str:
    """The function assigns protection or attack depending
...
def start_training(char_name: str, char_class: str) -> str:
    """the function describes the logic of character training."""
...
def choice_char_class() -> str:
    """the function describes the character 
