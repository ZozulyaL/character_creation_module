...
def attack(char_name: str, char_class: str) -> str:
    """Описывает логику работы функции атак.
    и присваивает очки.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Назначает защиту в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Назначает защиту или атаку в зависимости от действий персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает логику тренировки в игре."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбираем персонажа и подтверждаем выбор."""
    approve_choice: str = ''
    char_class: str = ''
